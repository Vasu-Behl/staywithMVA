      ...
      <section className="max-w-6xl mx-auto px-4 pb-10">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          ...
          <div className="relative rounded-3xl bg-white shadow-xl overflow-hidden">
            <img
              src={withBase("Pgsingle.jpg")}
              alt="Single Room"
              className="w-full h-64 object-cover"
            />
            <div className="p-6 text-center">
              <p className="text-xl font-semibold text-gray-900 font-inter">
                Single Room — ₹15,000<span className="text-gray-500 text-base align-top">*</span>
              </p>
          ...
          <div className="relative rounded-3xl bg-white shadow-xl overflow-hidden">
            <img
              src={withBase("Pgdouble.jpg")}
              alt="Double Room"
              className="w-full h-64 object-cover"
            />
            <div className="p-6 text-center">
              <p className="text-xl font-semibold text-gray-900 font-inter">
                Double Room — ₹12,000<span className="text-gray-500 text-base align-top">*</span>
              </p>
              <p className="text-sm text-gray-500">per month</p>
            </div>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-4 pb-16">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          <div className="rounded-2xl bg-white shadow p-6 text-center">
            <p className="font-semibold text-gray-800 mb-2 font-inter">Morning</p>
          ...
          <div className="rounded-2xl bg-white shadow p-6 text-center">
            <p className="font-semibold text-gray-800 mb-2 font-inter">Evening</p>
            <div className="flex items-center justify-center gap-2 text-purple-700">
          ...
          <div className="rounded-2xl bg-white shadow p-6 text-center">
            <p className="font-semibold text-gray-800 mb-2 font-inter">Night</p>
            <div className="flex items-center justify-center gap-2 text-purple-700">
        ...
        <p className="mt-4 text-sm text-gray-600">
          Meals are <span className="font-semibold">included</span> in the price. The exact
          menu is decided every month by the residents themselves.
        </p>
      </section>
